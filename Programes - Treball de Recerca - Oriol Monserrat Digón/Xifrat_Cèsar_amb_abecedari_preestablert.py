#!/usr/bin/env python
"""
Xifrat_Cèsar_amb_abecedari_preestablert.py.
Programa per encriptar text amb la Xifra de Cèsar.

Aquest programa rep un text introduït per l'usuari, demana el desplaçament que
desitja i encripta el missatge utilitzant la xifra de Cèsar.

Institut Icària

Aquest programa aplica el xifratge de Cèsar a un text donat. El resultat és
una cadena de text on les lletres han estat desplaçades en l'abecedari segons
el valor indicat com a desplaçament.
"""
